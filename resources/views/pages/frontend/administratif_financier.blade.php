...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-wrapper">
                        <h1 class="page-title mb-10">Administratifs</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="breadcrumb-menu">
                    ...
                    <ul class="trail-items">
                        ...
                        <li class="trail-item trail-end"><span>Administratifs</span></li>
                    </ul>
                    </nav>
                </div>
            </div>
    ...
    <section class="about-info-area pt-130 pb-130">
        <div class="container">
            @if ($administratif_financier)
                
                @foreach ($administratif_financier as $items)
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="about-info-content">
                                <span class="about-info-content-span">Admnistratif</span>
