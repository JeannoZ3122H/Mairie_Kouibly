            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-wrapper">
                        <h1 class="page-title mb-10">Sécrétariat général</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="breadcrumb-menu">
                    ...
                    <ul class="trail-items">
                        ...
                        <li class="trail-item trail-end"><span>Sécrétariat général</span></li>
                    </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="about-info-content">
                                <span class="about-info-content-span">Sécrétariat général</span>
