...
class CreateAutorisationParentalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('autorisation_parentales', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('autorisation_parentales');
    }
}
